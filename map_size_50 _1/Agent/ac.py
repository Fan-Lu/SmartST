...
class Network(nn.Module):
    def __init__(self, input_channel=3):
        ...
        self.conv1 = nn.Conv2d(in_channels=input_channel, out_channels=8, kernel_size=3, stride=2)
...
class Actor(nn.Module):
    def __init__(self, A_DIM=4, num_channel=3):
        super(Actor, self).__init__()
        self.network = Network(num_channel)
